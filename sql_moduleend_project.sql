...
VALUES (1, 201, 'XYZ', '9876543210'),
       (2, 202, 'LMN', '9123456789'),
       (3, 203, 'OPQ', '9988776655'),
       (4, 204, 'RST', '9871234567'),
       (5, 205, 'UVW', '9654321098'),
       (6, 206, 'XYZ', '9456781230');

-- Insert data into Employee table
INSERT INTO Employee (Emp_Id, Emp_name, Position, Salary, Branch_no)
VALUES (201, 'Alice Johnson', 'Librarian', 35000, 2),
       (202, 'Bob Smith', 'Library Manager', 65000, 1),
       (203, 'Charlie Brown', 'Cashier', 36000, 5),
       (204, 'Diana Prince', 'Library Assistant', 47000, 1),
       (205, 'Eve Adams', 'Library Clerk', 41000, 2),
       (206, 'Frank Wright', 'Library Technician', 42000, 3),
       (207, 'Grace Lee', 'Security', 27000, 4),
...
VALUES (201, 'Lily Evans', '456 Def', '2023-04-18'),
       (202, 'James Potter', '789 Ghi', '2024-02-12'),
       (203, 'Sirius Black', '101 Jkl', '2022-10-15'),
